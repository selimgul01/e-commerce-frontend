...
const CommentModal = ({ item }) => {
  const { status, feedbackMessage } = useSelector((state) => state.review);
            ...
            <div className="flex flex-col mt-5">
              ...
              <div className="pt-8 flex flex-col space-y-2">
                ...
                <textarea
                  ...
                  className="h-[100px] w-full outline-none border border-gray-300 rounded-lg p-3"
                  placeholder="Ürünün hem fiyatı uygun hem de göründüğü gibi kaliteli bir ürün."
                  maxlength="2000"
                  minlength="0"
                ></textarea>
              </div>
